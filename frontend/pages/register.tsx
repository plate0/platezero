...
import { createUser, login } from '../common/http'
...
class RegisterForm extends React.Component<{}, RegisterFormState> {
  ...
  public async handleSubmit(event: React.FormEvent<EventTarget>) {
        ...
        <Col xs="12" lg={{ size: 6, offset: 3 }} className="mt-3">
          ...
          <Form onSubmit={this.handleSubmit}>
            ...
            <FormGroup>
              ...
              />
              <FormText>
                Your username must be 2–25 characters long, start with a letter,
                and consist only of letters, numbers, hyphens, and underscores.
              </FormText>
            </FormGroup>
            <FormGroup>
              ...
              />
              <FormText>
                We’ll use this email address to help you access your account if
                you forget your password. We never share your email or spam you!
              </FormText>
            </FormGroup>
            <FormGroup>
